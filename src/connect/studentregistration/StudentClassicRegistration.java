...
public class StudentClassicRegistration 
{
	...
	@Test
	public void RegisterStudentClassic() throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
	{
		// Get Test Data
		...
		rp.registerstudent(studentid,studentpwd,studentFirstName,studentLastName);
	}
